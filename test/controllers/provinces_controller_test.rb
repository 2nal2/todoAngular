...
class ProvincesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create province" do
    assert_difference('Province.count') do
      post provinces_url, params: { province: { Country: @province.Country, belongs_to: @province.belongs_to, country_id: @province.country_id, name: @province.name, status: @province.status } }
    end
  ...
  test "should update province" do
    patch province_url(@province), params: { province: { Country: @province.Country, belongs_to: @province.belongs_to, country_id: @province.country_id, name: @province.name, status: @province.status } }
