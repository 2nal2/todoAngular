...
class PresentationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presentation" do
    assert_difference('Presentation.count') do
      post presentations_url, params: { presentation: { measure_id: @presentation.measure_id, name: @presentation.name } }
    end
  ...
  test "should update presentation" do
    patch presentation_url(@presentation), params: { presentation: { measure_id: @presentation.measure_id, name: @presentation.name } }
